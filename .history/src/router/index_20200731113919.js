...
Vue.use(VueRouter)
  ...
  },
  {
    path:'/editr',
    naem:'editr',
    component:()=>import('../views/address/editr.vue')
  },
  {
    path:'/evaluate',
    name:'evaluate',
  ...
  },
  {
    path:'/orderr',
    name:'orderr',
    component:()=>import('../views/order/orderr.vue')
  },
  {
    path:'/evaluater',
    name:'evaluater',
    component:()=>import('../views/evaluate/evaluater.vue')
  },
  {
    path:'/evaluaterr',
    name:'evaluaterr',
    component:()=>import('../views/evaluate/evaluaterr.vue')
  },
  {
    path:'/location',
    name:'location',
