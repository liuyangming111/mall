<template>
  <div>
    ...
    <van-cell-group>
      ...
      <van-field v-model="data" label="出生年月" placeholder="请更改您的出生年月" />
...
export default {
  ...
  mounted() {
    ...
    this.arr = `${this.userInfo.year}${this.userInfo.month}${this.userInfo.day}`
    console.log(this.arr)
    this.data=dayjs(this.arr).format('YYYY年MM月DD日')
  },
  watch: {},
  computed: {},
};
