<template>
  <div style="background-color: rgb(238,238,238)">
    ...
    <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white" v-if="slides.length>0">
      <van-swipe-item>
        <img :src="slides[0].image" alt  @click="$toDetails(item.goodsId)"/>
      </van-swipe-item>
      <van-swipe-item>
        <img :src="slides[1].image" alt  @click="$toDetails(item.goodsId)"/>
      </van-swipe-item>
      <van-swipe-item>
        <img :src="slides[2].image" alt  @click="$toDetails(item.goodsId)/>
      </van-swipe-item>
    </van-swipe>
    <div class="category">
