  ...
  <div>
    ...
    <div v-else>
      <div class="Select_all">
        <van-checkbox v-model="checked" class="Select_alls" @change="changeAll">全选</van-checkbox>
      ...
      <div v-for="(item,index) in shopList" :key="index" class="commodity">
        <van-checkbox v-model="item.check" class="checkbox" @change="item"></van-checkbox>
        <div class="border">
