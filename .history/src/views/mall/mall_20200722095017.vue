<template>
  <div style="background-color: rgb(238,238,238)">
    ...
    <malll name="1F" floorName="新鲜水果" :floor="floor1"></malll>
    <malll name="2F" floorName="新鲜水果" :floor="floor2"></malll>
    <malll name="3F" floorName="新鲜水果" :floor="floor3"></malll>
  </div>
</template>
    ...
    getData() {
      this.$api
        ...
        .then(res => {
          ...
          this.floor3 = res.data.floor3;floorName
