<template>
  <div>
    ...
    <van-goods-action>
      ...
      <van-popup v-model="show" position="bottom" closeable close-icon="close" :style="{ height: '30%'}" overlay>
        <div style="display: flex;">
            <img :src="goodsOne.image" alt="" class="images">
            <div>
              <div class="Prices">{{goodsOne.name}}</div>
              <div style="color:red">￥{{goodsOne.present_price}}</div>
            </div>
