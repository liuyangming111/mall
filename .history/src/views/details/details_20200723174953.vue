<template>
  <div>
    ...
    <div>
      <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white" @click="preview">
        <van-swipe-item v-for="(item,index) in goodsOne" :key="index">
    ...
    <van-tabs v-model="active">
      <van-tab title="商品详情"><div v-html='goodsOne.detail'></div></van-tab>
    ...
    <van-goods-action>
      ...
      <van-goods-action-button type="warning" text="加入购物车"  @click="$Pop_up"/>
  ...
  mounted() {
    ...
    this.$api
      ...
      .then(res => {
        ...
        this.arr=[this.goodsOne.image,this.]
